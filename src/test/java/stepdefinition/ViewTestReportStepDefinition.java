...
public class ViewTestReportStepDefinition {
	...
	@Given("patients already exist in the system")
	public void patients_already_exist_in_the_system() {
	...
	public void the_table_header_should_be_displayed(String string) {
	...
	@Then("each report row should display a Record Number")
	public void each_report_row_should_display_a_record_number() {
	   
	}

	@Then("each report row should display a View PDF button")
	public void each_report_row_should_display_a_view_pdf_button() {
	    
	}

	@Then("each report row should display the Uploaded Time")
	public void each_report_row_should_display_the_uploaded_time() {
	    
	}

	@Then("each report row should display the File\\/Report Name")
	public void each_report_row_should_display_the_file_report_name() {
	    
	}

	@Then("each report row should display Vitals information")
	public void each_report_row_should_display_vitals_information() {
	    
	}

	@Then("each report row should display Identified Health Conditions")
	public void each_report_row_should_display_identified_health_conditions() {
